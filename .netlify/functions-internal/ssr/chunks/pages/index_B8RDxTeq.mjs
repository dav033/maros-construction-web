import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute, i as renderComponent, j as renderSlot } from '../astro_ULg2rZTi.mjs';
import 'kleur/colors';
import 'html-escaper';
import { d as images, e as $$Image, c as $$Layout } from './about-us_BknxQ6Hd.mjs';
...
const image1 = new Proxy({"src":"/_astro/imagePresentation1.Mkl90NSm.webp","width":1200,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/src/assets/images/imagePresentation1.webp";
							}
...
const image2 = new Proxy({"src":"/_astro/ImagePresentation2.CmR-1g1T.webp","width":1200,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/src/assets/images/ImagePresentation2.webp";
							}
...
const image1Medium = new Proxy({"src":"/_astro/imagePresentation1-medium.C1l0CtB2.webp","width":1050,"height":540,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/src/assets/images/imagePresentation1-medium.webp";
							}
...
const image1Small = new Proxy({"src":"/_astro/imagePresentation1-small.C5loiii7.webp","width":500,"height":535,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/src/assets/images/imagePresentation1-small.webp";
							}
...
const image2Medium = new Proxy({"src":"/_astro/ImagePresentation2-medium.DTQowsJd.webp","width":1050,"height":540,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/src/assets/images/ImagePresentation2-medium.webp";
							}
...
const $$ImagePresentation = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`imageContent principal`, "class")} data-astro-cid-xaqbfght> <picture data-astro-cid-xaqbfght> <source${addAttribute(image1Medium.src, "srcset")} media="(max-width: 1050px)" type="image/webp" data-astro-cid-xaqbfght> <source${addAttribute(image1Small.src, "srcset")} media="(max-width: 500px)" type="image/webp" data-astro-cid-xaqbfght> ${renderComponent($$result, "Image", $$Image, { "src": image1, "alt": "Presentation 1", "class": "background-image image1", "loading": "eager", "width": 1200, "height": 1e3, "data-astro-cid-xaqbfght": true })} </picture> <picture data-astro-cid-xaqbfght> <source${addAttribute(image2Medium.src, "srcset")} media="(max-width: 1050px)" type="image/webp" data-astro-cid-xaqbfght> ${renderComponent($$result, "Image", $$Image, { "src": image2, "alt": "Presentation 2", "class": "background-image image2", "width": 1200, "height": 1e3, "data-astro-cid-xaqbfght": true })} </picture> <h3 data-astro-cid-xaqbfght>Building your dreams, one by one.</h3> </div> `;
...
const image = new Proxy({"src":"/_astro/aboutImage.C2FIPZ5Q.webp","width":1200,"height":1600,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/src/assets/images/aboutImage.webp";
							}
...
MAROS CONSTRUCTION is a company specialized in a wide variety of
        ...
        foundation.
</p> <a href="/about-us" aria-label="About Us" data-astro-cid-u5srh6iw>About Us</a> </div> </div> <div class="image" data-astro-cid-u5srh6iw> ${renderComponent($$result, "Image", $$Image, { "src": image, "alt": "About Us", "width": 800, "height": 600, "data-astro-cid-u5srh6iw": true })} </div> </section> `;
