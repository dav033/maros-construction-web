...
import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as renderComponent, j as renderHead, k as renderSlot } from '../astro_Drz9_Bhe.mjs';
import 'kleur/colors';
import 'html-escaper';
import { r as resolveSrc, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_CCgzi3uk.mjs';
import 'clsx';
/* empty css                             */
/* empty css                             */
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_CCgzi3uk.mjs'
    ).then(n => n.s).catch((e) => {
...
const concrete = new Proxy({"src":"/_astro/1000246271_c561b.CbreqlaU.webp","width":920,"height":2048,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/1000246271_c561b.webp";
							}
...
const driveway = new Proxy({"src":"/_astro/1000229765_1740c.BUvHsZP1.webp","width":357,"height":349,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/1000229765_1740c.webp";
							}
...
const waterproofing = new Proxy({"src":"/_astro/1000249305_0194e.DF1faH2g.webp","width":380,"height":507,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/1000249305_0194e.webp";
							}
...
const home = new Proxy({"src":"/_astro/1000229731_e0979.DQ1NYWVk.webp","width":1536,"height":2048,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/1000229731_e0979.webp";
							}
...
const additions = new Proxy({"src":"/_astro/1200_800.DE7mz5kg.webp","width":1200,"height":800,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/1200_800.webp";
							}
...
const about1 = new Proxy({"src":"/_astro/1000247660_69036.Dx8P-VZF.webp","width":805,"height":504,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/1000247660_69036.webp";
							}
...
const about2 = new Proxy({"src":"/_astro/1000243960_d832b.W-9i4OWe.webp","width":805,"height":505,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/1000243960_d832b.webp";
							}
...
const imageAboutUsPrincipal = new Proxy({"src":"/_astro/aboutUsPrincipal.Bno7jax3.webp","width":1200,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/aboutUsPrincipal.webp";
							}
...
const imageMediumAboutUsPrincipal = new Proxy({"src":"/_astro/aboutUsPrincipal-medium.C9O8x7s_.webp","width":1000,"height":500,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/aboutUsPrincipal-medium.webp";
							}
...
const imageSmallAboutUsPrincipal = new Proxy({"src":"/_astro/aboutUsPrincipal-small.CW4Lufk-.webp","width":500,"height":250,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/aboutUsPrincipal-small.webp";
							}
...
const imagePresentation1 = new Proxy({"src":"/_astro/imagePresentation1.Mkl90NSm.webp","width":1200,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/imagePresentation1.webp";
							}
...
const imagePresentation2 = new Proxy({"src":"/_astro/ImagePresentation2.CmR-1g1T.webp","width":1200,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/ImagePresentation2.webp";
							}
...
const imagePresentation1Medium = new Proxy({"src":"/_astro/imagePresentation1-medium.C1l0CtB2.webp","width":1050,"height":540,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/imagePresentation1-medium.webp";
							}
...
const imagePresentation2Medium = new Proxy({"src":"/_astro/ImagePresentation2-medium.DTQowsJd.webp","width":1050,"height":540,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/ImagePresentation2-medium.webp";
							}
...
const imagePresentation1Small = new Proxy({"src":"/_astro/imagePresentation1-small.C5loiii7.webp","width":500,"height":535,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/imagePresentation1-small.webp";
							}
...
const imagePresentation2Small = new Proxy({"src":"/_astro/ImagePresentation2-small.B3DuYVow.webp","width":500,"height":535,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/ImagePresentation2-small.webp";
							}
...
const imageAboutPresentation = new Proxy({"src":"/_astro/aboutImage.C2FIPZ5Q.webp","width":1200,"height":1600,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/aboutImage.webp";
							}
...
const design = new Proxy({"src":"/_astro/design.BwgiDSFK.webp","width":400,"height":300,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/design.webp";
							}
...
const laws = new Proxy({"src":"/_astro/laws.BB5qnHkq.webp","width":400,"height":300,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/laws.webp";
							}
...
const images = {
  ...
  about1,
  about2,
  imageAboutUsPrincipal,
  imageMediumAboutUsPrincipal,
  imageSmallAboutUsPrincipal,
  imagePresentation1,
  imagePresentation2,
  imagePresentation1Medium,
  imagePresentation2Medium,
  imagePresentation1Small,
...
const $$AboutUsPrincipal = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="principal" data-astro-cid-wk2j4euz> <div data-astro-cid-wk2j4euz> <h1 data-astro-cid-wk2j4euz>Who Are We?</h1> <picture data-astro-cid-wk2j4euz> <source${addAttribute(images.imageMediumAboutUsPrincipal.src, "srcset")} media="(max-width: 1050px)" type="image/webp" data-astro-cid-wk2j4euz> <source${addAttribute(images.imageSmallAboutUsPrincipal.src, "srcset")} media="(max-width: 500px)" type="image/webp" data-astro-cid-wk2j4euz> ${renderComponent($$result, "Image", $$Image, { "src": images.imageAboutUsPrincipal, "alt": "sampleImage", "class": "background-image", "width": 1200, "height": 1e3, "loading": "eager", "data-astro-cid-wk2j4euz": true })} </picture> <p data-astro-cid-wk2j4euz>
...
const icon = new Proxy({"src":"/_astro/marosicon1-light.aY0LrFl6.webp","width":763,"height":327,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/marosicon1-light.webp";
							}
...
const mobileIconDark = new Proxy({"src":"/_astro/marosicon1-dark.BuD52T6u.webp","width":763,"height":327,"format":"webp"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/david/maros-construction/public/images/marosicon1-dark.webp";
							}
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><link rel="stylesheet" href="../../public/styles/global.css"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="preload" type="image/webp" fetchpriority="high" as="image" href="src/assets/images/imagePresentation1.webp"><link rel="preload" type="image/webp" fetchpriority="high" as="image" href="src/assets/images/imagePresentation2.webp"><meta name="generator"${addAttribute(Astro2.generator, "content")}>${renderHead()}</head> <body> ${renderComponent($$result, "Navbar", $$Navbar, {})} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})}  </body> </html>`;
...
const $$Mision = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Mision;
  return renderTemplate`${maybeRenderHead()}<section data-astro-cid-wvao3l6t> <div class="mision" data-astro-cid-wvao3l6t> ${renderComponent($$result, "Image", $$Image, { "src": images.about1, "alt": "Journey", "data-astro-cid-wvao3l6t": true })} <div class="container" data-astro-cid-wvao3l6t> <h1 data-astro-cid-wvao3l6t>Our Journey</h1> <p data-astro-cid-wvao3l6t>
...
const $$Process = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Process;
  return renderTemplate`${maybeRenderHead()}<section class="process" data-astro-cid-lgh2v675> <h2 data-astro-cid-lgh2v675>Understand our process</h2> <div class="container" data-astro-cid-lgh2v675> ${renderComponent($$result, "ProcessItem", $$ProcessItem, { "title": "Collaboration and Design", "image": images.design, "data-astro-cid-lgh2v675": true }, { "default": ($$result2) => renderTemplate`
...
` })} ${renderComponent($$result, "ProcessItem", $$ProcessItem, { "title": "Permits and Approvals", "image": images.laws, "data-astro-cid-lgh2v675": true }, { "default": ($$result2) => renderTemplate`
